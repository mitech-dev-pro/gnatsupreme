...
async function seedGeography() {
  ...
  if (expectedRegions !== 16 || expectedDistricts !== 261) {
    throw new Error(
      `Invalid geography seed: expected 16 regions/261 districts, got ${expectedRegions}/${expectedDistricts}`,
    );
  }
  ...
  console.log(
    `Geography seed complete: ${regionCount} regions and ${districtCount} districts in the database.`,
  );
}
