...
const endpoints: Endpoint[] = [
  ...
  { method: "post", path: "/api/member-auth/login", summary: "Member login (Controller ID + password)", tag: "Member authentication", security: "public" },
  { method: "post", path: "/api/member-auth/forgot-password", summary: "Request a member password reset email", tag: "Member authentication", security: "public" },
  { method: "post", path: "/api/member-auth/reset-password", summary: "Complete a member password reset", tag: "Member authentication", security: "public" },
