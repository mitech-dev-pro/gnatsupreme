...
export default function FileUploadField({
  ...
  return (
    <label
      className={`relative inline-flex min-h-8 cursor-pointer items-center gap-1.5 rounded-lg border border-(--mint-border,var(--border-default)) bg-surface-subtle px-2.5 text-xs font-bold text-action-primary hover:border-action-primary ${disabled || busy ? "pointer-events-none opacity-60" : ""}`}
    >
