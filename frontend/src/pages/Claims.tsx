...
export default function Claims() {
  ...
  return <div>
    ...
    <ClaimsTable
      ...
      onReviewed={load}
      onError={setError}
      emptyState={<EmptyState title="No claim submissions yet" description="File the first claim to begin tracking its details and processing status." action={<Button onClick={() => navigate("/claims/new")}>File a claim</Button>}/>}
    />
