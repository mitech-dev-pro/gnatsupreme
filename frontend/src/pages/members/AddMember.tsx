  ...
  return <main className="enroll-page">
    ...
    {reviewing ? <section className="enroll-review">
      ...
      <form className="enroll-form" onSubmit={review} noValidate>
        ...
        <section ref={householdSection} id="household"><div className="enroll-section-title"><i>3</i><div><h2>Covered lives</h2><p>Record spouse and beneficiary information.</p></div></div>
