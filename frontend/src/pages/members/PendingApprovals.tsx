...
type Member = { id: number; controllerId: string; fullName: string; ghanaCardId: string | null; phone: string | null; phoneVerifiedAt: string | null; school: string; employmentCategory: "TEACHING" | "NON_TEACHING"; report20Matched: boolean; createdAt: string; district: { id: number; name: string; region: { id: number; name: string } } | null; spouse: unknown | null; _count: { beneficiaries: number }; createdBy: { id: number; fullName: string } | null };
...
function Report20Signal({ member, no }: { member: { employmentCategory: "TEACHING" | "NON_TEACHING"; report20Matched: boolean }; no: string }) {
  if (member.employmentCategory === "NON_TEACHING") return <span className="approval-signal"><i>–</i>Not applicable (non-teaching)</span>;
