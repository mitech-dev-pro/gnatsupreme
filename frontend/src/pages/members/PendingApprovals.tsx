...
type Member = { id: number; controllerId: string; fullName: string; ghanaCardId: string | null; phone: string | null; phoneVerifiedAt: string | null; school: string; report20Matched: boolean; createdAt: string; district: { id: number; name: string; region: { id: number; name: string } } | null; spouse: unknown | null; _count: { beneficiaries: number }; createdBy: { id: number; fullName: string } | null };
